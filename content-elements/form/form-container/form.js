...
Alpine.data('formElement', () => ({
  ...
  submitForm(e) {
    if (!this.form.checkValidity()) {
      ...
      this.form.querySelectorAll('.bsi-form-element').forEach((formElement) => {
        if (formElement.classList.contains('validated')) {
          formElement.getElementsByClassName('invalid-feedback')[0].style.display = "none";
        } else {
          formElement.getElementsByClassName('invalid-feedback')[0].style.display = "block";
        }
      })
    }
